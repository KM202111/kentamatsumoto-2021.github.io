# Bluetooth 2021-04-13 23:51 までの備忘録
...
あ、電池持ち書いてなかった.   
ZephyrOS™️ / nRF Connect SDK 使用時、DCDCモードで基板設計して、昇圧無し、1.7V まで駆動出来るようにハードウェアを設計した形（要は 1.7V まで動くセンサーを１個くっ付けてって事）で  

CR2032(220mAh) で 88時間程度  
CR1632(140mAh) で 49時間程度  
